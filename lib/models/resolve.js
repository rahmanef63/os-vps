 ...
 * @param {{tenantId?:string, store:import('./store.js').CredentialStore, baseUrl?:string, info?:boolean}} opts
 * @returns {Promise<ResolvedModel>}
 */
export async function resolveModel(ref, { tenantId, store, baseUrl, info = false } = {}) {
